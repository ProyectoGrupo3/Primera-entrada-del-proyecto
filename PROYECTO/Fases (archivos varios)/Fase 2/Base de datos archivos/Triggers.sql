...
DECLARE
BEGIN
IF :NEW.EXCESO_HORAS < 480 THEN
:NEW.EXCESO_HORAS:= 0;
ELSE IF :NEW.EXCESO_HORAS < 540 THEN
:NEW.EXCESO_HORAS:= 1;
ELSE IF :NEW.EXCESO_HORAS < 600 THEN
:NEW.EXCESO_HORAS:= 2;
ELSE IF :NEW.EXCESO_HORAS < 660 THEN
:NEW.EXCESO_HORAS:= 3;
ELSE IF :NEW.EXCESO_HORAS < 720 THEN
:NEW.EXCESO_HORAS:= 4;
ELSE IF :NEW.EXCESO_HORAS < 780 THEN
:NEW.EXCESO_HORAS:= 5;
ELSE IF :NEW.EXCESO_HORAS < 840 THEN
:NEW.EXCESO_HORAS:= 6;
ELSE IF :NEW.EXCESO_HORAS < 900 THEN
:NEW.EXCESO_HORAS:= 7;
ELSE IF :NEW.EXCESO_HORAS < 960 THEN
:NEW.EXCESO_HORAS:= 8;
END IF;
END IF;
END IF;
