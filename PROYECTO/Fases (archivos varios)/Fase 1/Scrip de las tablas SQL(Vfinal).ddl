...
CREATE UNIQUE INDEX CP__IDX ON CP ( Trabajador_ID_Trabajador ASC ) ;
CREATE UNIQUE INDEX CP__IDXv1 ON CP ( Vehiculo_Matricula ASC ) ;
...
CREATE PUBLIC SYNONYM TAVISO FOR AVISO;
CREATE PUBLIC SYNONYM TCENTRO_TRABAJO FOR CENTRO_TRABAJO;
CREATE PUBLIC SYNONYM TCLAVE FOR CLAVE;
CREATE PUBLIC SYNONYM TCP FOR CP;
CREATE PUBLIC SYNONYM TLP FOR LP;
CREATE PUBLIC SYNONYM TTRABAJADOR FOR TRABAJADOR;
CREATE PUBLIC SYNONYM TVEHICULO FOR VEHICULO;
