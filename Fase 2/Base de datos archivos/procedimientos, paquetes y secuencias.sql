...
END;
  ...
  CREATE OR REPLACE PROCEDURE INSERT_TRABAJADOR(
T_ID IN TRABAJADOR.ID_TRABAJADOR%TYPE,
T_DNI IN TRABAJADOR.DNI%TYPE,
T_NOMBRE IN TRABAJADOR.NOMBRE%TYPE,
T_APE1 IN TRABAJADOR.APELLIDO_1%TYPE,
T_APE2 IN TRABAJADOR.APELLIDO_2%TYPE,
T_CALLE IN TRABAJADOR.CALLE%TYPE,
T_PORTAL IN TRABAJADOR.PORTAL%TYPE,
T_PISO IN TRABAJADOR.PISO%TYPE,
T_MANO IN TRABAJADOR.MANO%TYPE,
T_TP IN TRABAJADOR.TELEFONO_PERSONAL%TYPE,
T_ME IN TRABAJADOR.MOVIL_EMPRESA%TYPE,
T_SALARIO IN TRABAJADOR.SALARIO%TYPE,
T_FN IN TRABAJADOR.FECHA_NACIMIENTO%TYPE,
T_CATE IN TRABAJADOR."CATEGORIA"%TYPE,
T_CT IN TRABAJADOR.CENTRO_TRABAJO_ID_CENTRO%TYPE)
AS
BEGIN
      INSERT INTO  TTRABAJADOR VALUES (T_ID, T_DNI, T_NOMBRE, T_APE1, T_APE2, T_CALLE, T_PORTAL, T_PISO, T_MANO,
      T_TP, T_ME, T_SALARIO, T_FN, T_CATE, T_CT);
...
CREATE PUBLIC SYNONYM INSERTAR_TRABAJADOR FOR INSERT_TRABAJADOR;
